document.addEventListener("DOMContentLoaded", () => {
    ...
    // Database dummy untuk pencarian konten statis
        ...
        { title: "Kamus Python - Bab 5: Membuat Buku Resep Sendiri (Functions)", url: "kamus-python/bab-5.html", desc: "Cara membuat fungsi dan menyimpannya.", keywords: "def, function, fungsi, resep, return, kembalikan, hasil, parameter, argument, default parameter, bahan cadangan" },
        { title: "Kamus Python - Bab 6: Meminjam Alat Tetangga (Modul & Imports)", url: "kamus-python/bab-6.html", desc: "Menggunakan modul, library, dan pip.", keywords: "import, modul, library, from, as, alias, pip install, pip list, gudang, alat" },
        { title: "Kamus Python - Bab 7: Kotak P3K Dapur (Penanganan Error)", url: "kamus-python/bab-7.html", desc: "Menangani exception dan error (try-except).", keywords: "try, coba, except, tangkap, error, finally, else, exception as e, raise, lempar error" },
        { title: "Kamus Python - Bab 8: Membangun Pabrik Cetakan (OOP)", url: "kamus-python/bab-8.html", desc: "Pengenalan Object-Oriented Programming (Class).", keywords: "class, oop, object, objek, instance, init, self, attribute, property, sifat, method, aksi, inheritance, pewarisan, super" },
